...
class Slots(View):
 ...
 def E(self,t,d,c=0x8B5CF6):
  e=discord.Embed(title=t,description=d,color=c);e.set_footer(text="🎰 Lucky Slots • Good luck!");return e
 async def edit(self,i,e):await i.response.edit_message(embed=e,view=self)
 ...
 async def spin(self,i,b):
  ...
  if m<10:return await self.edit(i,self.E("💀 BANKRUPT","You've run out of money!\n\n💥 Your 2% JACKPOT is available.",0xEF4444))
  money[self.u]-=10;s=[random.choice(["🍒","🍋","🔔","💎","7️⃣"]) for _ in range(3)]
  if random.random()<.25:
   p=random.choice([25,50,100,250]);money[self.u]+=p;r=f"🎉 WIN! You won ${p:,}!";c=0x22C55E
